                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-sm">
                        contact@fruitshadiyatsahra.com
                      </p>
                    </div>
                  </div>
